var express = require('express'),
    ...
    brill_data = require(`${path}brill_data.js`)
...
router.post('/brill_data', function (req, res) {
	brill_data.brill_data_func(req, res, function (err, data) {
		if (err) {
			res.json({
				'success': false,
				'message': 'Error with endpoint brill_data.. !'
			});
		} else {
			res.json({
				'success': true,
				'message': 'brill_data endpoint executed successfully'
			});
		}
	});
});
