...
<html data-editor-version="2" class="sg-campaigns" xmlns="http://www.w3.org/1999/xhtml">
  ...
  <body>
    ...
    <table class="wrapper" role="module" data-type="image" border="0" cellpadding="0" cellspacing="0" width="100%" style="table-layout: fixed;">
       <tr style=" background-color: green !important;color: #ffffff; border-radius: 15px 15px 0px 0px;">
        ...
        <td height="100%" valign="center">
          <span style="font-family:georgia,serif; font-size:26px;"> FAT</span>
        </td>
      </tr>
  ...
  New Formula Created. Please find the below details. </td></tr>
    </table>
    <br>
...
<table align="center" border="1" cellpadding="5px" cellspacing="0" style="width:100%;">
  <tbody>
     <tr style="text-align:center;">
      ...
      <td style="width:200px;max-width:33.333%;"><div style="text-align: center;"><b>Formula Code</b></div></td>
      <td style="width:200px;max-width:33.333%;"><div style="text-align: center;">{{formula_code}}</div></td>
    </tr>
   
   
   
    <tr>
        <td style="width:200px;max-width:33.333%;"><div style="text-align: center;"><b>Formula Name</b></div></td>
      <td style="width:200px;max-width:33.333%;"><div style="text-align: center;">{{formula_name}}</div></td>
    ...
    <td style="width:200px;max-width:33.333%;"><div style="text-align: center;"><b>Date</b></div></td>
      <td style="width:200px;max-width:33.333%;"><div style="text-align: center;">{{date}}</div></td>

    </tr>
        <tr>
    <td style="width:200px;max-width:33.333%;"><div style="text-align: center;"><b>Plant</b></div></td>
      <td style="width:200px;max-width:33.333%;"><div style="text-align: center;">{{plant}}</div></td>

    </tr>
      <tr>
    <td style="width:200px;max-width:33.333%;"><div style="text-align: center;"><b>Version</b></div></td>
      <td style="width:200px;max-width:33.333%;"><div style="text-align: center;">{{version}}</div></td>

    </tr>

    </tr>
      <tr>
    <td style="width:200px;max-width:33.333%;"><div style="text-align: center;"><b>Batch Weight (KG)</b></div></td>
      <td style="width:200px;max-width:33.333%;"><div style="text-align: center;">{{batch_weight}}</div></td>
...
Percentage (%)
    ...
    <tr>
      <!--<td style="width:200px;max-width:33.333%;"><img class="max-width" border="0" style="display:block;color:#000000;text-decoration:none;font-family:Helvetica, arial, sans-serif;font-size:16px;max-width:100% !important;width:100%;height:auto !important;" src="{{this.image}}" alt="Product Image" width="200"></td>-->
      <td style="width:200px;max-width:33.333%;"><div style="text-align: center;">{{LINE_ITEM_NO}}</div></td>
      <td style="width:200px;max-width:33.333%;"><div style="text-align: center;">{{BRILL_MAT_CODE}}</div></td>
      <td style="width:200px;max-width:33.333%;"><div style="text-align: left;">{{Description}}</div></td>
      <td style="width:200px;max-width:33.333%;"><div style="text-align: center;">{{MATERIAL_QTY}}</div></td>
      <td style="width:200px;max-width:33.333%;"><div style="text-align: center;">{{PERCENT}}</div></td>
...
<!--      </tr>-->
<!--    </table>-->
    <p>Link to See the Formula: <a href={{link}} target="_blank">{{link}}</a> </p><br>
    ...
    <table class="module"
      ...
      <tr>
        ...
        <td height="100%" valign="right" style="padding: 10px 0px 10px 30px;">
          <div>
         <span style="font-size: 14px;line-height: 10px;"> For feedback/support, write an email to <span style="color:yellow;">fat@ibgroup.co.in</span></span><br>
         <span style="font-size: 14px;line-height: 10px;">  For issues, raise a ticket in Intranet ITSM portal.</span><br>
           <span style="font-size: 14px;"> Regards, </span><br>
             <span style="font-size: 14px;line-height: 10px;">  Team FAT </span>
       </div>
        </td>
      </tr>
        <td style="padding:0px 0px 0px 0px;"
