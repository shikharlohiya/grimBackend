...
<html data-editor-version="2" class="sg-campaigns" xmlns="http://www.w3.org/1999/xhtml">
  ...
  Dear Sir/Madam, </td></tr>
      <tr ><td style="padding:0px 0px 10px 0px;line-height:20px;text-align:inherit;">
  New formula has been created. Please check the details in the SAP. </td></tr>
    </table>
    <br>
...
<table align="center" border="1" cellpadding="5px" cellspacing="0" style="width:100%;">
  <tbody>
     <tr style="text-align:center;">
      ...
      <td style="width:200px;max-width:33.333%;"><div style="text-align: left;"><b>Formula Code</b></div></td>
      <td style="width:200px;max-width:33.333%;"><div style="text-align: left;">{{formula_code}}</div></td>
    </tr>
   
   
   
    <tr>
        <td style="width:200px;max-width:33.333%;"><div style="text-align: left;"><b>Formula Name</b></div></td>
      <td style="width:200px;max-width:33.333%;"><div style="text-align: left;">{{formula_name}}</div></td>
    ...
    <td style="width:200px;max-width:33.333%;"><div style="text-align: left;"><b>Date</b></div></td>
      <td style="width:200px;max-width:33.333%;"><div style="text-align: left;">{{date}}</div></td>

    </tr>
        <tr>
    <td style="width:200px;max-width:33.333%;"><div style="text-align: left;"><b>Plant</b></div></td>
      <td style="width:200px;max-width:33.333%;"><div style="text-align: left;">{{plant}}</div></td>

    </tr>
      <tr>
    <td style="width:200px;max-width:33.333%;"><div style="text-align: left;"><b>Version</b></div></td>
      <td style="width:200px;max-width:33.333%;"><div style="text-align: left;">{{version}}</div></td>

    </tr>

    </tr>
      <tr>
    <td style="width:200px;max-width:33.333%;"><div style="text-align: left;"><b>Batch Weight (KG)</b></div></td>
      <td style="width:200px;max-width:33.333%;"><div style="text-align: left;">{{batch_weight}}</div></td>
